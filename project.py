...
weapons_4_or_more_days = male_participants[male_participants['q12']==4] 
count = weapons_4_or_more_days.shape[0]

print(count)
plt.bar('male sudents with weapons', count, 4, 4)
plt.show()

## out of the amount of males see how many were in a fight
count2 = weapons_4_or_more_days[weapons_4_or_more_days['q17']=='1']
count2 = count2.shape[0]
print(f"count 2 = {count2}")
